...
class AppConfig {
  ...
  static const String _devHostIp = '172.27.28.125';

  /// Deployed API (release builds default here unless overridden).
  static const String _productionBackendOrigin =
      'http://3.109.235.112:3040';
  ...
  static String get backendOrigin {
    ...
    if (Platform.isAndroid) return 'http://$_devHostIp:3000';
